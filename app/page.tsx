...
export default function Home() {
  ...
  const [currentCategory, setCurrentCategory] = useState<TrendingCategory>('all')
  const [currentPeriod, setCurrentPeriod] = useState<TrendingPeriod>('daily')
  ...
  }, [currentCategory, currentPeriod, selectedDate, fetchTrendingData])
